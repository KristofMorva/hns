...
changeTeam( team )
{
	...
	//self maps\mp\gametypes\_spectating::setSpectatePermissions(); // HNS
...
/*	if ( game["allies_soldiertype"] == "desert" )
	...
	if ( game["axis_soldiertype"] == "desert" )
	{
		...
		//mptype\mptype_velinda_desert::precache();
		...
		//game["axis_model"]["GIRL"] = mptype\mptype_velinda_desert::main;
